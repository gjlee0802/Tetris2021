...
//3x3
int T1D0[] = { 0, 2, 0, 2, 2, 2, 0, 0, 0, -1 };
int T1D1[] = { 0, 2, 0, 0, 2, 2, 0, 2, 0, -1 };
int T1D2[] = { 0, 0, 0, 2, 2, 2, 0, 2, 0, -1 };
int T1D3[] = { 0, 2, 0, 2, 2, 0, 0, 2, 0, -1 };

//3x3
int T2D0[] = { 3, 0, 0, 3, 3, 3, 0, 0, 0, -1 };
int T2D1[] = { 0, 3, 3, 0, 3, 0, 0, 3, 0, -1 };
int T2D2[] = { 0, 0, 0, 3, 3, 3, 0, 0, 3, -1 };
int T2D3[] = { 0, 3, 0, 0, 3, 0, 3, 3, 0, -1 };

//3x3
int T3D0[] = { 0, 0, 4, 4, 4, 4, 0, 0, 0, -1 };
int T3D1[] = { 0, 4, 0, 0, 4, 0, 0, 4, 4, -1 };
int T3D2[] = { 0, 0, 0, 4, 4, 4, 4, 0, 0, -1 };
int T3D3[] = { 4, 4, 0, 0, 4, 0, 0, 4, 0, -1 };

//3x3
int T4D0[] = { 0, 5, 0, 5, 5, 0, 5, 0, 0, -1 };
int T4D1[] = { 5, 5, 0, 0, 5, 5, 0, 0, 0, -1 };
int T4D2[] = { 0, 5, 0, 5, 5, 0, 5, 0, 0, -1 };
int T4D3[] = { 5, 5, 0, 0, 5, 5, 0, 0, 0, -1 };

//3x3
int T5D0[] = { 0, 6, 0, 0, 6, 6, 0, 0, 6, -1 };
int T5D1[] = { 0, 0, 0, 0, 6, 6, 6, 6, 0, -1 };
int T5D2[] = { 0, 6, 0, 0, 6, 6, 0, 0, 6, -1 };
int T5D3[] = { 0, 0, 0, 0, 6, 6, 6, 6, 0, -1 };

//4x4
int T6D0[] = { 0, 0, 0, 0, 7, 7, 7, 7, 0, 0, 0, 0, 0, 0, 0, 0, -1 };
